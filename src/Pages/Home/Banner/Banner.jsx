...
const Banner = () => {
    ...
    >
      ...
      {/* <SwiperSlide><img className="w-full h-full" src={banner1} /></SwiperSlide>
      <SwiperSlide><img className="w-full h-full" src={banner1} /></SwiperSlide>
      <SwiperSlide><img className="w-full h-full" src={banner1} /></SwiperSlide> */}
    </Swiper>
    );
